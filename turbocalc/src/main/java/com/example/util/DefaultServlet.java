...
// MODIFIED BY mitchell.mebane@gmail.com
// * Enable sending charset=UTF-8 for JS/CSS files
 ...
 *                    
 *  textEncoding      Charset to send for CSS/JS files
 *
 *
 * </PRE>
 *
...
public class DefaultServlet extends HttpServlet implements ResourceFactory
{
    ...
    private static final Set<String> _textMimeTypes = new HashSet<String>();
    static {
    	_textMimeTypes.add("text/css");
    	_textMimeTypes.add("application/javascript");
    }
    ...
    throws UnavailableException
    {
        ...
        _textEncoding = getInitParameter("textEncoding");
        if (null == _textEncoding)
        {
            _textEncoding = "UTF-8";
        }
    }
        ...
        if ( reqRanges == null || !reqRanges.hasMoreElements() || content_length<0)
        {
            ...
            else
            {
                ...
                if (response instanceof Response)
                {
                    ...
                    if(_textMimeTypes.contains(contentType))
                	{
                    	r.setContentType(contentType + "; charset=" + _textEncoding);
                	}
